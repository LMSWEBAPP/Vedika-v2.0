    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.leftTagline}>
          <span className={styles.brandWord}>VEDIKA</span>
          <span className={styles.slashDivider}>{'//'}</span>
          <span className={styles.taglineText}>AI FOR A BRIGHTER TOMORROW</span>
        </div>
        ...
        <div className={styles.rightGroup}>
          ...
          <span className={styles.copyrightText}>&copy; 2026 Vedika Systems</span>
        </div>
      </div>
    </footer>
  );
