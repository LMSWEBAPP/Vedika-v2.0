...
export default function Sidebar({ isCollapsed = false, onToggleCollapse }) {
  ...
  return (
    <div style={{
      ...
      {/* Brand Header */}
      <div style={{ padding: isCollapsed ? '0 0 10px' : '0 16px 14px', borderBottom: `1px solid ${T.border}`, marginBottom: 12, display: 'flex', flexDirection: 'column', alignItems: 'center', flexShrink: 0 }}>
